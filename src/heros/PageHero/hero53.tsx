  ...
  return (
    <section className="relative py-32">
      <div className="container">
        <div className="absolute inset-0 -z-10 size-full bg-[radial-gradient(hsl(var(--muted-foreground))_1px,transparent_1px)] opacity-35 [background-size:14px_14px]"></div>
